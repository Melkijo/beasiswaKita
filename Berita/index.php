...
<head>
  ...
  <title>BeasiswaKita - Berita</title>
...
<body>
    ...
    <div class="container-fluid navbar-margin">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/tubesWeb/beasiswa/index.php">Beasiswa</a>
          </li>
          <li class="nav-item">
  ...
  <div class="row mt-5">
    <div class="col-6">
      <p class="fs-3 fw-bold ms-4">Terkini</p>
    </div>
  </div>
  </div>
    ...
    <div class="row mb-5">
      <div class="col-lg-3">
        <div class="card mx-auto">
          ...
          <div class="card-body">
            <div class="card-title">Pidato Bpk Menteri</div>
  ...
  <div class="footer-section">
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <a href="/tubesWeb/index.html" style="text-decoration: none; color: white;">
          <div class="navigasi-item">- Utama</div>
        </a>
        <a href="/tubesWeb/tentang/tentang.html" style="text-decoration: none; color: white;">
          <div class="navigasi-item">- Tentang</div>
        </a>
        <a href="index.html" style="text-decoration: none; color: white;">
          <div class="navigasi-item">- Berita</div>
        </a>
        <a href="/tubesWeb/beasiswa/index.html" style="text-decoration: none; color: white;">
