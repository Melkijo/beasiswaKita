...
<body>
    ...
    <div class="dashboard-profile">
        <div class="dashboard-profile-title">
            <h5>Input Beasiswa</h5>
        </div>
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="exampleInputEmail1"  class="form-label">Nama Beasiswa</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="namaBeasiswa">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1"  class="form-label">Penyelenggara</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="namaPenyelenggara">
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                          <label for="InputPassword1" class="form-label">Pendidikan</label>
                          <br>
                          <select class="btn btn-secondary" name="pendidikanRegistrasi" id="list">
                        ...
                        <div class="col">
                          <label for="InputPassword1" class="form-label">Minat</label>
                          <br>
                          <select class="btn btn-secondary" id="list" name="minatRegistrasi">
            ...
            <input type="submit" value="Tambah" class="btn btn-primary" name="submitBeasiswa">
        </form>
    </div>
